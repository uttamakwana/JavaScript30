...
// console.log("%cThis is big text", "font-size: 20px; color: green; background-color: #bada55; padding: 16px");
...
fetch("https://jsonplaceholder.typicode.com/todos/1").then(data => data.json()).then(data => { console.log(data); console.timeEnd("Fetching data") })
